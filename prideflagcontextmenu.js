const { ContextMenuCommandBuilder, ApplicationCommandType, EmbedBuilder, ActionRowBuilder, ButtonBuilder, ButtonStyle, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, AttachmentBuilder, UserContextMenuCommandInteraction, MessageContextMenuCommandInteraction } = require('discord.js');
    ...
    */
    ...
    const menuSelection = new StringSelectMenuBuilder()
      ...
      .setOptions(new StringSelectMenuOptionBuilder({
        ...
        label: '[◖ Left',
        description: 'Keeps the left side of wide flags, cropping out the right',
        value: 'left'
      }), new StringSelectMenuOptionBuilder({
        label: '◗] Right',
        description: 'Keeps the right side of wide flags, cropping out the left',
        value: 'right'
      }), new StringSelectMenuOptionBuilder({
        label: '[⬮] Stretch',
        description: '(Not recommended) Resizes wide flags to fit the template',
        value: 'stretch'
      }));
    ...
    if (img.length != 0) {
      await interaction.reply({
        ...
        components: [
          ...
          new ActionRowBuilder().addComponents(/*buttonPreview, buttonRevert,*/ buttonConvert, buttonCancel),
